...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/pianolit.css')}}">
            ...
            <div class="col-lg-4 col-md-6 col-sm-8 col-xs-10 mx-auto text-white">
                <form class="form-horizontal" method="POST" action="{{ route('pianolit.admin.login.submit') }}">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-6 mx-auto mb-4 text-center">
                        <img class="w-100 mb-2" src="{{asset('images/projects/pianolit/icon.svg')}}" style="border-radius: 22%; vertical-align: sub;">
