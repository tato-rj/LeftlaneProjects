<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
  <a class="navbar-brand mr-0" href="/piano-lit"><img src="{{asset('images/projects/pianolit/icon.svg')}}" class="mr-2"><span class="text-brand">Piano<strong>LIT</strong></span></a>
