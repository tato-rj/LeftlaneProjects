<div class="col-12 mb-2">
  <div class="d-flex justify-content-between px-3 py-2 
    ...
    <div class="text-right ml-2 d-flex" style="white-space: nowrap;">
      <div class="mr-2">
        <span class="mr-1"><small><i class="fas fa-info mr-1"></i>{{$piece->tips_count}}</small></span>
      ...
      <div class="text-brand">
        @created($piece)
        <a href="/piano-lit/pieces/{{$piece->id}}">edit</a> | <a href="" data-name="{{$piece->name}}" data-url="/piano-lit/pieces/{{$piece->id}}" data-toggle="modal" data-target="#delete-modal" class="delete">delete</a>
        @else
        <a href="/piano-lit/pieces/{{$piece->id}}">view details</a>
        @endcreated
      </div>
    </div>
  </div>
