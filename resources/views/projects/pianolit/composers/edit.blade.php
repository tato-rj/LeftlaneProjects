...
<div class="content-wrapper">
  ...
  @include('projects/pianolit/components/breadcrumb', [
    ...
    <div class="row my-5 mx-2">
      <form id="edit-form" method="POST" action="/piano-lit/composers/{{$composer->id}}" class="col-lg-6 col-sm-10 col-12 mx-auto">
        {{csrf_field()}}
        {{method_field('PATCH')}}
        {{-- Name --}}
      ...
      <div class="col-lg-6 col-sm-10 col-12 mx-auto">
        <p class="text-muted"><strong>{{$composer->name}} has {{$pieces->count()}} {{str_plural('piece', $pieces->count())}}</strong></p>
        @if($pieces->count() > 0)
