...
<div class="d-inline position-relative">
	...
	<div class="position-absolute rounded-circle bg-success text-white font-weight-bold d-flex align-items-center justify-content-center" style="bottom: 0; right: 2px; width: 10px; height: 10px; font-size: .5em"><i class="fas fa-check"></i></div>	
	@else
